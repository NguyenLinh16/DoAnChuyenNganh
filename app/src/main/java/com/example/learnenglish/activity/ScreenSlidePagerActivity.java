...
public class ScreenSlidePagerActivity extends FragmentActivity {
    ...
    public class DepthPageTransformer implements ViewPager.PageTransformer {
        private static final float MIN_SCALE = 0.75f;// Là hệ số để xác định tỷ lệ thu nhỏ nhất cho trang
    ...
    public void checkDapan(){
        ...
        //Khởi tạo một CheckAnswerAdapter và cung cấp nó với danh sách câu hỏi (list_question) và context của activity.
