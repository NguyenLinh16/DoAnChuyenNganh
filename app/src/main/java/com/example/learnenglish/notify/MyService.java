package com.example.learnenglish.notify;

import static com.example.learnenglish.notify.MyAppliction.CHANNEL_ID;
...
public class MyService extends Service {
    ...
    private PendingIntent getPendingIntent(Context context, int action){
        ...
        Intent intent = new Intent(this,MyRecevice.class);
